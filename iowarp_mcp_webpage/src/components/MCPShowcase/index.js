...
const PlatformButton = ({ platform, mcpName, onCopy }) => {
  ...
  const installCommand = `uvx iowarp-mcps ${mcpName.toLowerCase().replace(/ /g, '-')}`;
  ...
  return (
    ...
    >
      <img
        src={`/iowarp-mcps/img/logos/${config.logo}`}
        alt={config.label}
  ...
  return (
    <Link to={`/docs/mcps/${mcp.slug}`} className={styles.featuredCard} data-category={mcp.category}>
      ...
      <div className={styles.featuredHeader}>
        <img
          src={`/iowarp-mcps/img/logos/${mcpId}-logo.svg`}
          alt={`${mcp.name} logo`}
          className={styles.featuredLogo}
          onError={(e) => {
            // Try PNG if SVG fails
            const pngSrc = `/iowarp-mcps/img/logos/${mcpId}-logo.png`;
        ...
        <div className={styles.featuredTitleSection}>
          ...
          <div className={styles.featuredMeta}>
            ...
            <a
              href={`https://github.com/iowarp/iowarp-mcps/tree/main/iowarp_mcp_servers/${mcpId}`}
