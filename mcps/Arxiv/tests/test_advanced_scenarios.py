...
<feed xmlns="http://www.w3.org/2005/Atom">
    <entry>
        ...
        <link href="http://arxiv.org/pdf/2301.12345v1.pdf" type="application/pdf" />
            ...
            download_result = await mcp_handlers.download_paper_pdf_handler(paper_id, "/tmp")
    ...
    <entry>
        ...
        <category term="cs.LG" />
            ...
            complex_scenarios = [
                ...
                ("search_by_subject_handler", ["artificial intelligence healthcare", 5]),
                ...
                ("search_date_range_handler", ["2023-01-01", "2023-01-01", 5]),  # Same date
                ("search_date_range_handler", ["2020-12-31", "2021-01-01", 5]),  # Year boundary
            ]
    ...
    <entry>
        ...
        <arxiv:primary_category term="cs.AI" />
            ...
            for paper_id in paper_ids:
                ...
                similar_result = await mcp_handlers.find_similar_papers_handler(paper_id, 5)
