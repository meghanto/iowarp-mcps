...
class TestMCPHandlers:
    ...
    async def test_get_recent_papers_handler_success(self):
        ...
        with patch('mcp_handlers.get_recent_papers', new_callable=AsyncMock) as mock_recent:
    ...
    async def test_search_papers_by_author_handler_success(self):
        ...
        with patch('mcp_handlers.search_papers_by_author', new_callable=AsyncMock) as mock_author:
            mock_author.return_value = expected_result
            
            result = await mcp_handlers.search_papers_by_author_handler("Test Author", 10)
    ...
    async def test_search_by_title_handler_success(self):
        ...
        with patch('mcp_handlers.search_by_title', new_callable=AsyncMock) as mock_title:
    ...
    async def test_search_by_abstract_handler_success(self):
        ...
        with patch('mcp_handlers.search_by_abstract', new_callable=AsyncMock) as mock_abstract:
            mock_abstract.return_value = expected_result
            
            result = await mcp_handlers.search_by_abstract_handler("machine learning", 10)
    ...
    async def test_search_by_subject_handler_success(self):
        ...
        with patch('mcp_handlers.search_by_subject', new_callable=AsyncMock) as mock_subject:
            mock_subject.return_value = expected_result
            
            result = await mcp_handlers.search_by_subject_handler("Computer Science", 10)
    ...
    async def test_search_date_range_handler_success(self):
        ...
        with patch('mcp_handlers.search_date_range', new_callable=AsyncMock) as mock_date:
            mock_date.return_value = expected_result
            
            result = await mcp_handlers.search_date_range_handler("2023-06-01", "2023-06-30", "", 10)
    ...
    async def test_get_paper_details_handler_success(self):
        ...
        with patch('mcp_handlers.get_paper_details', new_callable=AsyncMock) as mock_details:
    ...
    async def test_find_similar_papers_handler_success(self):
        ...
        with patch('mcp_handlers.find_similar_papers', new_callable=AsyncMock) as mock_similar:
    ...
    async def test_export_to_bibtex_handler_success(self):
        ...
        with patch('mcp_handlers.export_to_bibtex', new_callable=AsyncMock) as mock_export:
    ...
    async def test_download_paper_pdf_handler_success(self):
        ...
        with patch('mcp_handlers.download_paper_pdf', new_callable=AsyncMock) as mock_download:
    ...
    async def test_download_multiple_pdfs_handler_success(self):
        ...
        with patch('mcp_handlers.download_multiple_pdfs', new_callable=AsyncMock) as mock_multi:
    ...
    async def test_all_handlers_error_format_consistency(self):
        ...
        for handler_name, args in handlers_to_test:
            if hasattr(mcp_handlers, handler_name):
                ...
                with patch(f'mcp_handlers.{func_name}', new_callable=AsyncMock) as mock_func:
    ...
    async def test_json_parameter_parsing(self):
        ...
        for json_str in json_test_cases:
            result = await mcp_handlers.download_multiple_pdfs_handler(json_str, "/tmp", 1)
            assert result is not None
    ...
    async def test_invalid_json_parameter_handling(self):
        ...
        for invalid_json in invalid_json_cases:
            ...
            result = await mcp_handlers.download_multiple_pdfs_handler(invalid_json, "/tmp", 1)
            assert result is not None
    ...
    async def test_date_range_edge_cases(self):
        ...
        for start_date, end_date, max_results in date_edge_cases:
            result = await mcp_handlers.search_date_range_handler(start_date, end_date, max_results)
            assert result is not None
        ...
        for handler_name, expected_tool_name in handlers_and_tools:
            if hasattr(mcp_handlers, handler_name):
                ...
                with patch(f'mcp_handlers.{func_name}', new_callable=AsyncMock) as mock_func:
                    ...
                    elif handler_name in ["export_to_bibtex_handler", "download_multiple_pdfs_handler"]:
                    ...
                    elif "search" in handler_name and handler_name != "search_date_range_handler":
                        result = await handler("test", 5)
                    else:
                        result = await handler("test")
