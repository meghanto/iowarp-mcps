...
from capabilities.jarvis_handler import (
    create_pipeline, load_pipeline, append_pkg, build_pipeline_env,
    update_pipeline, configure_pkg, get_pkg_config, unlink_pkg,
    remove_pkg, run_pipeline, destroy_pipeline
)
...
class TestIntegrationScenarios:
    ...
    async def test_complete_pipeline_workflow(self, mock_pipeline):
        ...
        # Append packages
        append_result1 = await append_pkg("workflow_test", "data_loader", pkg_id="loader1")
        ...
        # Configure packages
        config_result = await configure_pkg("workflow_test", "loader1", input_path="/data")
