...
from chronomcp.capabilities import record_handler, retrieve_handler, start_handler, stop_handler
...
class TestIntegration:
    ...
    async def test_basic_workflow(self):
        ...
        retrieve_result = await retrieve_handler.retrieve_interaction(chronicle_name, story_name)
