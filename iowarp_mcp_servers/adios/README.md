...
uv --directory=$CLONE_DIR/iowarp-mcps/iowarp_mcp_servers/adios run adios-mcp --help
```
...
$env:CLONE_DIR=$PWD
git clone https://github.com/iowarp/iowarp-mcps.git
uv --directory=$env:CLONE_DIR\iowarp-mcps\iowarp_mcp_servers\adios run adios-mcp --help
```
