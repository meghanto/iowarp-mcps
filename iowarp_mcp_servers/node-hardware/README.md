...
uv --directory=$CLONE_DIR/iowarp-mcps/iowarp_mcp_servers/node-hardware run node-hardware-mcp --help
```
...
set CLONE_DIR=%cd%
git clone https://github.com/iowarp/iowarp-mcps.git
uv --directory=%CLONE_DIR%\iowarp-mcps\iowarp_mcp_servers\node-hardware run node-hardware-mcp --help
```
...
$env:CLONE_DIR=$PWD
git clone https://github.com/iowarp/iowarp-mcps.git
uv --directory=$env:CLONE_DIR\iowarp-mcps\iowarp_mcp_servers\node-hardware run node-hardware-mcp --help
```
